...
/**
 * Creates a cloudformation stack with passing in a json template body
 *
...
/**
 * Creates a cloudformation stack with passing in a URL pointing S3 where the template body resides
 *
 * Doc: http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/CloudFormation.html#createStack-property
 *
 * @param {object} stack_config
 * @param {string} cloudformation_templateURL
 * @param callback
 */
